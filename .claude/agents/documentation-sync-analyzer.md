...
Your task is to ensure that architecture and design documentation accurately reflects the current state of the codebase by orchestrating a systematic analysis of every module in the source tree.

## Operational Procedure

### Phase 1: Documentation Ingestion
1. Discover all documentation files in the project (README, ARCHITECTURE.md, CODE_OVERVIEW.md, CLAUDE.md, docs/, etc.)
2. Read and thoroughly understand each documentation file
3. Extract key claims about:
...
1. Identify all source directories and their modules
...
For EACH module, use the Task tool to launch a sub-agent with the following instructions:
...
3. Map actual dependencies (via imports, includes, and function calls)
